export const projects = [
  ...
  //   codeLink: "",
  //   info: "You may need to view with a VPN",
  //   name: "Tonado",
  //   technologies: [
  //     "React",
  //     "Next.js",
  ...
  },
  {
    ...
    description:
      "The AI-powered social media automation tool that helps you create, schedule, and post content. Connect once, grow forever.",
  },
  {
    image: "/yciyc.jpeg",
  ...
  },
  {
    ...
    description:
      "Afriq bot is the telegram mini app platform of Afriq Exchange (AfriqX). AAST is the native Token of Afriq Exchange (AfriqX) and the utility token of Afriq Group of Companies. Built on Binance Smart Chain (BEP20)",
  },
  {
    image: "/tonnie.png",
